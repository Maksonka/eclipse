...
public class MessageService {
    ...
    public Message saveAudioMessage(String senderUsername, String receiverUsername, String audioUrl, Long replyToMessageId) {
        return saveAudioMessage(senderUsername, receiverUsername, audioUrl, replyToMessageId, null);
    }

    public Message saveAudioMessage(String senderUsername, String receiverUsername, String audioUrl, Long replyToMessageId, Long audioDurationMs) {
        User receiver = userService.findByUsername(receiverUsername)
                .orElseThrow(() -> new RuntimeException("пользователь не найден"));
        User sender = userService.findByUsername(senderUsername)
                .orElseThrow(() -> new RuntimeException("пользователь не найден"));
