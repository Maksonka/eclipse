...
private final ReactionService reactionService;
    ...
    public String openChat(@PathVariable String receiverUsername,
        ...
        if (blockService.hasBlockBetween(principal.getName(), receiverUsername)) {
            redirectAttributes.addFlashAttribute("flashError",
                    "Чат с этим пользователем недоступен");
            return "redirect:/chat";
        }
    ...
    public ResponseEntity<Map<String, Object>> sendAttachment(@PathVariable String receiverUsername,
        ...
        try {
            blockService.assertCanMessage(principal.getName(), receiverUsername);
