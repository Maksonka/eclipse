...
public class ProfileController {
    ...
    public ProfileController(UserService userService, BlockService blockService) {
    ...
    public String viewProfile(@PathVariable String username,
        ...
        model.addAttribute("viewerBlocksProfile", blockService.isBlocked(principal.getName(), username));
        return "profile";
    }
    ...
    public String blockUser(@PathVariable String username,
                            ...
                            RedirectAttributes redirectAttributes) {
        try {
            blockService.block(principal.getName(), username);
            redirectAttributes.addFlashAttribute("profileNotice",
